...
/// </summary>
public partial class ReceiptsTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Id", "Vendor", "Date", "Type", "Amount", "Actions" };
    ...
    {
        _columns["Id"] = new ColumnDef { Name = "Id", StarValue = 1.0, MinWidth = 100, PreferredWidth = 120 };
        _columns["Vendor"] = new ColumnDef { Name = "Vendor", StarValue = 1.5, MinWidth = 140, PreferredWidth = 180 };
        _columns["Date"] = new ColumnDef { Name = "Date", StarValue = 1.0, MinWidth = 100, PreferredWidth = 120 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "Vendor": VendorColumnWidth = width; break;
