...
/// </summary>
public partial class InvoicesTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Id", "Customer", "IssueDate", "DueDate", "Amount", "Status", "Actions" };
    ...
    private void InitializeColumns()
    {
        ...
        _columns["Customer"] = new ColumnDef { Name = "Customer", StarValue = 1.4, MinWidth = 140, PreferredWidth = 180 };
        _columns["IssueDate"] = new ColumnDef { Name = "IssueDate", StarValue = 0.9, MinWidth = 90, PreferredWidth = 110 };
        _columns["DueDate"] = new ColumnDef { Name = "DueDate", StarValue = 0.9, MinWidth = 90, PreferredWidth = 110 };
        _columns["Amount"] = new ColumnDef { Name = "Amount", StarValue = 0.8, MinWidth = 80, PreferredWidth = 100 };
        _columns["Status"] = new ColumnDef { Name = "Status", StarValue = 0.8, MinWidth = 80, PreferredWidth = 100 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "IssueDate": IssueDateColumnWidth = width; break;
