...
/// </summary>
public partial class PaymentsTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Id", "Invoice", "Customer", "Date", "Method", "Amount", "Status", "Actions" };
    ...
    private void InitializeColumns()
    {
        ...
        _columns["Invoice"] = new ColumnDef { Name = "Invoice", StarValue = 0.8, MinWidth = 80, PreferredWidth = 100 };
        _columns["Customer"] = new ColumnDef { Name = "Customer", StarValue = 1.2, MinWidth = 120, PreferredWidth = 160 };
        _columns["Date"] = new ColumnDef { Name = "Date", StarValue = 0.8, MinWidth = 90, PreferredWidth = 110 };
        _columns["Method"] = new ColumnDef { Name = "Method", StarValue = 0.7, MinWidth = 70, PreferredWidth = 90 };
        _columns["Amount"] = new ColumnDef { Name = "Amount", StarValue = 0.8, MinWidth = 80, PreferredWidth = 100 };
        _columns["Status"] = new ColumnDef { Name = "Status", StarValue = 0.7, MinWidth = 80, PreferredWidth = 100 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "Invoice": InvoiceColumnWidth = width; break;
            case "Customer": CustomerColumnWidth = width; break;
            case "Date": DateColumnWidth = width; break;
            case "Method": MethodColumnWidth = width; break;
