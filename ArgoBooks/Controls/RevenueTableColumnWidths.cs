...
/// </summary>
public partial class RevenueTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Id", "Customer", "Product", "Date", "Quantity",
    ...
    {
        _columns["Id"] = new ColumnDef { Name = "Id", StarValue = 0.8, MinWidth = 60, PreferredWidth = 80 };
        _columns["Customer"] = new ColumnDef { Name = "Customer", StarValue = 1.2, MinWidth = 100, PreferredWidth = 150 };
        _columns["Product"] = new ColumnDef { Name = "Product", StarValue = 1.5, MinWidth = 120, PreferredWidth = 180 };
        _columns["Date"] = new ColumnDef { Name = "Date", StarValue = 0.9, MinWidth = 80, PreferredWidth = 100 };
        _columns["Quantity"] = new ColumnDef { Name = "Quantity", StarValue = 0.5, MinWidth = 40, PreferredWidth = 60 };
        _columns["UnitPrice"] = new ColumnDef { Name = "UnitPrice", StarValue = 0.8, MinWidth = 70, PreferredWidth = 90 };
        _columns["Amount"] = new ColumnDef { Name = "Amount", StarValue = 0.8, MinWidth = 70, PreferredWidth = 90 };
        _columns["Tax"] = new ColumnDef { Name = "Tax", StarValue = 0.7, MinWidth = 50, PreferredWidth = 70 };
        _columns["Shipping"] = new ColumnDef { Name = "Shipping", StarValue = 0.7, MinWidth = 60, PreferredWidth = 80 };
        _columns["Discount"] = new ColumnDef { Name = "Discount", StarValue = 0.7, MinWidth = 60, PreferredWidth = 80 };
        _columns["Total"] = new ColumnDef { Name = "Total", StarValue = 0.8, MinWidth = 70, PreferredWidth = 90 };
        _columns["Receipt"] = new ColumnDef { Name = "Receipt", StarValue = 0.8, MinWidth = 50, PreferredWidth = 70 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "Customer": CustomerColumnWidth = width; break;
