...
/// </summary>
public partial class RentalRecordsTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Id", "Item", "Customer", "Quantity", "StartDate", "DueDate", "Status", "Total", "Deposit", "Actions" };
    ...
    {
        _columns["Id"] = new ColumnDef { Name = "Id", StarValue = 0.6, MinWidth = 80, PreferredWidth = 100 };
        _columns["Item"] = new ColumnDef { Name = "Item", StarValue = 1.0, MinWidth = 140, PreferredWidth = 180 };
        _columns["Customer"] = new ColumnDef { Name = "Customer", StarValue = 1.0, MinWidth = 140, PreferredWidth = 180 };
        _columns["Quantity"] = new ColumnDef { Name = "Quantity", StarValue = 0.4, MinWidth = 60, PreferredWidth = 80 };
        _columns["StartDate"] = new ColumnDef { Name = "StartDate", StarValue = 0.7, MinWidth = 90, PreferredWidth = 110 };
        _columns["DueDate"] = new ColumnDef { Name = "DueDate", StarValue = 0.7, MinWidth = 90, PreferredWidth = 110 };
        _columns["Status"] = new ColumnDef { Name = "Status", StarValue = 0.7, MinWidth = 90, PreferredWidth = 110 };
        _columns["Total"] = new ColumnDef { Name = "Total", StarValue = 0.6, MinWidth = 80, PreferredWidth = 100 };
        _columns["Deposit"] = new ColumnDef { Name = "Deposit", StarValue = 0.6, MinWidth = 80, PreferredWidth = 100 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "StartDate": StartDateColumnWidth = width; break;
            case "DueDate": DueDateColumnWidth = width; break;
