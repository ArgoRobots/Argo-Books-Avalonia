...
/// </summary>
public partial class CustomersTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Customer", "Email", "Phone", "Address",
        "PaymentStatus", "Outstanding", "LastRental", "Actions" };
    ...
    {
        _columns["Customer"] = new ColumnDef { Name = "Customer", StarValue = 1.2, MinWidth = 120, PreferredWidth = 180 };
        _columns["Email"] = new ColumnDef { Name = "Email", StarValue = 1.0, MinWidth = 100, PreferredWidth = 150 };
        _columns["Phone"] = new ColumnDef { Name = "Phone", StarValue = 0.8, MinWidth = 80, PreferredWidth = 110 };
        _columns["Address"] = new ColumnDef { Name = "Address", StarValue = 1.2, MinWidth = 120, PreferredWidth = 180 };
        _columns["PaymentStatus"] = new ColumnDef { Name = "PaymentStatus", StarValue = 0.8, MinWidth = 90, PreferredWidth = 110 };
        _columns["Outstanding"] = new ColumnDef { Name = "Outstanding", StarValue = 0.7, MinWidth = 80, PreferredWidth = 100 };
        _columns["LastRental"] = new ColumnDef { Name = "LastRental", StarValue = 0.8, MinWidth = 80, PreferredWidth = 110 };
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "Address": AddressColumnWidth = width; break;
            case "PaymentStatus": PaymentStatusColumnWidth = width; break;
            case "Outstanding": OutstandingColumnWidth = width; break;
            case "LastRental": LastRentalColumnWidth = width; break;
