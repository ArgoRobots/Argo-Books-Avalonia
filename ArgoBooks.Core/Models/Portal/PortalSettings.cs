...
public class PortalSettings
{
    ...
    /// <summary>
    /// Whether the portal API is configured (API key in .env file).
    /// </summary>
    [JsonIgnore]
    ...
    /// <summary>
    /// Whether to automatically publish invoices to the portal when sending via email.
    /// </summary>
    [JsonPropertyName("autoPublishOnSend")]
    public bool AutoPublishOnSend { get; set; } = true;
...
public class ConnectedPaymentAccounts
{
    ...
    /// </summary>
    [JsonIgnore]
    public bool HasAnyConnected => StripeConnected || PaypalConnected || SquareConnected;
}
