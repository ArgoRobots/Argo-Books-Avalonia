...
/// </summary>
public partial class DepartmentModalsViewModel : ViewModelBase
{
    #region Modal State
    ...
    public async void OpenDeleteConfirm(DepartmentDisplayItem? item)
    {
        ...
        {
            App.ErrorLogger?.LogError(ex, Core.Models.Telemetry.ErrorCategory.Validation, "Department.OpenDeleteConfirm");
        }
    }
