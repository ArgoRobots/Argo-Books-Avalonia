...
public partial class RevenueModalsViewModel : TransactionModalsViewModelBase<RevenueDisplayItem, RevenueLineItem>
{
    ...
    private void AddCustomerFromName(string? name)
    {
        ...
        var option = new CounterpartyOption { Id = newId, Name = newCustomer.Name };
    ...
    /// </summary>
    protected override void OnLineItemCreated(RevenueLineItem lineItem)
    {
    ...
    /// </summary>
    private void AddProductFromNameForLineItem(string? name, RevenueLineItem lineItem)
    {
        if (string.IsNullOrWhiteSpace(name)) return;
        ...
        if (category == null)
        {
            ...
            {
                Id = $"CAT-REV-{companyData.IdCounters.Category:D3}",
