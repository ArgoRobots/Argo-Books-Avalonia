...
/// </summary>
public partial class CategoriesTableColumnWidths : ObservableObject, ITableColumnWidths
{
    ...
    private readonly string[] _columnOrder = { "Name", "Parent", "Description", "Type", "ProductCount", "Actions" };
    ...
    {
        _columns["Name"] = new ColumnDef { Name = "Name", StarValue = 1.5, MinWidth = 150, PreferredWidth = 200 };
        _columns["Parent"] = new ColumnDef { Name = "Parent", StarValue = 1.0, MinWidth = 100, PreferredWidth = 140 };
        _columns["Description"] = new ColumnDef { Name = "Description", StarValue = 1.5, MinWidth = 150, PreferredWidth = 200 };
        _columns["Type"] = new ColumnDef { Name = "Type", StarValue = 0.8, MinWidth = 80, PreferredWidth = 100 };
        _columns["ProductCount"] = new ColumnDef { Name = "ProductCount", StarValue = 0.8, MinWidth = 80, PreferredWidth = 120 };
        _columns["Actions"] = new ColumnDef { Name = "Actions", IsFixed = true, FixedWidth = 140, MinWidth = 140 };
    }
    ...
    private void ApplyWidthToProperty(string columnName, double width)
    {
        switch (columnName)
        {
            ...
            case "Parent": ParentColumnWidth = width; break;
            case "Description": DescriptionColumnWidth = width; break;
            case "Type": TypeColumnWidth = width; break;
            case "ProductCount": ProductCountColumnWidth = width; break;
