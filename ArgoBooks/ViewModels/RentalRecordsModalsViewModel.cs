...
public partial class RentalRecordsModalsViewModel : ViewModelBase
{
    ...
    public void SaveNewRecord()
    {
        ...
        var stockAdjustmentIds = new List<string>();
        foreach (var (invItem, _, qtyChange) in inventoryChanges)
        {
            ...
            var adjId = $"ADJ-{companyData.IdCounters.StockAdjustment:D5}";
            stockAdjustmentIds.Add(adjId);
            companyData.StockAdjustments.Add(new StockAdjustment
            {
                Id = adjId,
        ...
        App.UndoRedoManager.RecordAction(new DelegateAction(
            ...
            () =>
            {
                ...
                foreach (var adjId in adjIds)
                    companyData.StockAdjustments.RemoveAll(a => a.Id == adjId);
                companyData.MarkAsModified();
    ...
    public void SaveEditedRecord()
    {
        ...
        var editAdjIds = new List<string>();
        ...
        var savedEditAdjIds = editAdjIds;
        App.UndoRedoManager.RecordAction(new DelegateAction(
            ...
            () =>
            {
                ...
                foreach (var adjId in savedEditAdjIds)
                    companyData.StockAdjustments.RemoveAll(a => a.Id == adjId);
    ...
    public async void OpenDeleteConfirm(RentalRecordDisplayItem? record)
    {
        try
        {
            ...
            if (rentalRecord != null)
            {
                ...
                var deleteAdjIds = new List<string>();
                if (wasActive)
                {
                ...
                var savedDeleteAdjIds = deleteAdjIds;
                App.UndoRedoManager.RecordAction(new DelegateAction(
                    ...
                    () =>
                    {
                        ...
                        if (wasActive)
                        {
                            ...
                            foreach (var adjId in savedDeleteAdjIds)
                                companyData.StockAdjustments.RemoveAll(a => a.Id == adjId);
                        }
                        companyData.MarkAsModified();
    ...
    public void ConfirmReturn()
    {
        ...
        var returnAdjIds = new List<string>();
        ...
        var savedReturnAdjIds = returnAdjIds;
        ...
        App.UndoRedoManager.RecordAction(new DelegateAction(
            ...
            () =>
            {
                ...
                foreach (var adjId in savedReturnAdjIds)
                    companyData.StockAdjustments.RemoveAll(a => a.Id == adjId);
                companyData.MarkAsModified();
